...
\begin{table}[h]
\centering
\caption{Arquivos gerados pelos experimentos}
\vspace{0.5cm}
\begin{tabular}{r|lr}

										
 Arquivo & URL \\ % Note a separação de col. e a quebra de linhas
\hline                               % para uma linha horizontal
  Dados de geração e métricas CK		& \href{https://github.com/gmramos/usp-masters-degree/blob/master/Datasets/CSV/EvoSuite\%20data\%20and\%20CK\%20metrics.csv}{EvoSuite data and CK metrics.csv}\\
Conjunto de treinamento CKCK		& \href{https://github.com/gmramos/usp-masters-degree/blob/master/Datasets/WEKA/CBCK.arff}{CBCK.arff} \\
Conjunto de treinamento CKCK+		& \href{https://github.com/gmramos/usp-masters-degree/blob/master/Datasets/WEKA/CBCK\%2B.arff}{CBCK+.arff} \\
 Conjunto de treinamento CKCK10		& \href{https://github.com/gmramos/usp-masters-degree/blob/master/Datasets/WEKA/CBCK10.arff}{CBCK10.arff}
