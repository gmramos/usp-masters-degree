...
O algoritmo, ao ser executado, retornou uma precisão de 63.5\%, porém é possível notar a melhora na distribuição da matriz de confusão demonstrada na tabela \ref{confusao-hibrido+}, o algoritmo passou a reconhecer mais casos onde o algoritmo randômico deveria ser selecionado.


\begin{table}[h]
\centering
\caption{Arquivos de treinamento utilizados no formato do software Weka}
\vspace{0.5cm}
\begin{tabular}{r|lr}

										
 Conjunto de treinamento & Arquivo \\ % Note a separação de col. e a quebra de linhas
\hline                               % para uma linha horizontal
CKCK		& \href{https://github.com/gmramos/usp-masters-degree/blob/master/Datasets/WEKA/CBCK.arff}{CBCK.arff} \\
CKCK+		& \href{http://www.texample.net/tikz/resources/}{Tex Example Site} \\
 CKCK10		& \href{http://www.texample.net/tikz/resources/}{Tex Example Site}
\end{tabular}
\source{Gustavo Ramos, 2018}
\label{table:confusao-hibrido+}
\end{table}
